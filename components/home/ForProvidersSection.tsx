...
const PERKS = [
  { Icon: FaCalendarAlt,   titleKey: 'landing.forProvidersAgendaTitle',    descKey: 'landing.forProvidersAgendaDesc' },
  { Icon: FaClipboardList, titleKey: 'landing.forProvidersCatalogueTitle', descKey: 'landing.forProvidersCatalogueDesc' },
  { Icon: FaWallet,        titleKey: 'landing.forProvidersPaymentsTitle',  descKey: 'landing.forProvidersPaymentsDesc' },
  { Icon: FaUsers,         titleKey: 'landing.forProvidersReachTitle',     descKey: 'landing.forProvidersReachDesc' },
] as const
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div>
            <span className="inline-block text-sm font-semibold tracking-wider uppercase text-brand-sky mb-2">
              {t('landing.forProvidersEyebrow')}
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
              {t('landing.forProvidersHeading')}
            </h2>
            <p className="mt-3 text-base sm:text-lg text-white/75 max-w-xl">
              {t('landing.forProvidersSubheading')}
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {PERKS.map(p => {
                const Icon = p.Icon
                return (
                  <div key={p.titleKey} className="flex items-start gap-3.5 rounded-2xl bg-white/[0.07] border border-white/10 backdrop-blur-sm p-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-white leading-tight">{t(p.titleKey)}</h3>
                      <p className="text-xs text-white/65 mt-1 leading-relaxed">{t(p.descKey)}</p>
                    </div>
                  </div>
                )
              })}
            ...
            <div className="mt-8">
              ...
              >
                <FaUserMd /> {t('landing.forProvidersCta')} <FaArrowRight className="text-xs" />
              </Link>
            </div>
          </div>
        </div>
