...
const MissionVisionSection: React.FC = () => {
 ...
 {/* Mission */}
 <div className="bg-surface rounded-2xl p-8 shadow-lg card-hover">
 ...
 <h3 className="text-2xl font-bold text-fg ml-2">OUR MISSION</h3>
 </div>
 </div>
 ...
 <div>
 <span className="text-3xl"></span>
 <h3 className="text-2xl font-bold text-fg ml-2">OUR VISION</h3>
 </div>
 </div>
 ...
 <span className="text-3xl"></span>
 <h4 className="text-xl font-bold text-fg">What We Do</h4>
 </div>
 ...
 <span className="text-soft font-medium">Third-Party Administrator (TPA) services</span>
 </div>
 <div className="flex items-center gap-3 p-3 bg-teal-50 rounded-lg">
 <span className="w-2 h-2 bg-primary-teal rounded-full"></span>
 <span className="text-soft font-medium">Corporate health solutions</span>
 </div>
 </div>
 </div>
 </div>
