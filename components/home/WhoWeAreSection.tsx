...
const WhoWeAreSection: React.FC = () => {
 ...
 <h2 className="text-4xl font-bold text-fg">WHO WE ARE</h2>
 </div>
 ...
 <button className="bg-surface text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-subtle transition" >
 Join Our Team
 </button>
 <button className="border-2 border-white text-white px-6 py-3 rounded-xl font-semibold hover:bg-surface hover:text-primary-blue transition">
 Partner With Us
 </button>
 </div>
 </div>
 ...
 <div>
 <h4 className="text-2xl font-bold text-fg mb-8 text-center">Our Core Values</h4>
 ...
 <h5 className="text-lg font-semibold text-fg mb-2">{value.title}</h5>
 <p className="text-soft text-sm leading-relaxed">{value.description}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <h4 className="text-2xl font-bold text-fg mb-4">
 Disrupting Healthcare Through Innovation
 </h4>
 <p className="text-soft max-w-3xl mx-auto mb-6">
 ...
 <div className="text-soft">Founded</div>
 </div>
 <div className="text-center">
 <div className="text-3xl font-bold text-secondary-green">500+</div>
 <div className="text-soft">Healthcare Professionals</div>
 </div>
 <div className="text-center">
 <div className="text-3xl font-bold text-primary-teal">50,000+</div>
 <div className="text-soft">Lives Impacted</div>
 </div>
 </div>
 </div>
 </div>
