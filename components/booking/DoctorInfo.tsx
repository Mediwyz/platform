...
export default function DoctorInfo({ doctor, onNext }: DoctorInfoProps) {
 ...
 <span className="text-soft text-sm">({doctor.reviews} reviews)</span>
 </div>
 </div>
 </div>
 ...
 <p className="text-soft">{doctor.experience}</p>
 </div>
 <div>
 <h4 className="font-semibold text-fg mb-2">Consultation Fees</h4>
 ...
 <p className="text-soft">{doctor.languages.join(', ')}</p>
 </div>
 <div>
 <h4 className="font-semibold text-fg mb-2">Category</h4>
 ...
 <p className="text-soft">{doctor.clinicAffiliation}</p>
 </div>
 ...
 <p className="text-soft">{doctor.address}</p>
 </div>
 
 <div className="mb-6">
 <h4 className="font-semibold text-fg mb-2">Sub-specialties</h4>
 ...
 <p className="text-soft leading-relaxed">{doctor.bio}</p>
 </div>
 </div>
 </div>
