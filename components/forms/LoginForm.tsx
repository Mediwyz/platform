...
const LoginForm: React.FC = () => {
 ...
 <h3 className="text-2xl font-bold text-fg mb-2">Welcome Back</h3>
 <p className="text-soft">Sign in to your MediWyz account</p>
 </div>
 ...
 <div>
 <label htmlFor="email" className="block text-soft text-sm font-medium mb-2">
 Email Address
 </label>
 ...
 />
 <FaEnvelope className="absolute left-3 top-1/2 transform -translate-y-1/2 text-faint" />
 </div>
 {fieldErrors.email && (
 ...
 <div>
 <label htmlFor="password" className="block text-soft text-sm font-medium mb-2">
 Password
 </label>
 <div className="relative">
 <input
 ...
 onChange={handleChange}
 />
 <FaLock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-faint" />
 <button
 type="button"
 onClick={() => setShowPassword(!showPassword)}
 className="absolute right-3 top-1/2 transform -translate-y-1/2 text-faint hover:text-soft"
 >
 ...
 <input
 type="checkbox"
 className="rounded border-line text-primary-blue focus:ring-primary-blue"
 />
 <span className="ml-2 text-sm text-soft">Remember me</span>
 </label>
 ...
 <Link href="/forgot-password" className="text-sm text-[#0C6780] hover:underline">
 Forgot password?
 </Link>
 </div>
 </form>
 ...
 <span className="px-2 bg-surface text-soft">Or continue with</span>
 </div>
 </div>
 </div>
 ...
 disabled={isSubmitting}
 className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-line rounded-lg hover:bg-subtle transition disabled:opacity-50"
 >
 <FaGoogle className="text-red-500" />
 <span className="text-soft font-medium">Sign in with Google</span>
 </button>
 ...
 <Link href="/help" className="text-xs text-soft hover:underline">
