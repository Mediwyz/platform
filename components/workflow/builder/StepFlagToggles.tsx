...
/** Flags that can appear on a WorkflowStep - set by step-type defaultFlags
 *  or auto-generated by the builder's deriveStepsFromConfig. Admins never
 *  toggle video/audio flags manually; the engine merges them from the step type. */
