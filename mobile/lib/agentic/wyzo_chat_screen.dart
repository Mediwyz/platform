...
class _WyzoChatScreenState extends State<WyzoChatScreen> with SingleTickerProviderStateMixin {
  ...
  Widget? _nativeForPath(String p) {
    ...
    switch (p) {
      ...
      case '/insurance/analytics': return InsuranceAnalyticsScreen(loggedIn: li);
      case '/insurance/portfolio': return InsuranceMembersScreen(loggedIn: li);
      case '/insurance/billing': return InsuranceAnalyticsScreen(loggedIn: li);
      case '/admin': return AdminDashboardScreen(loggedIn: li);
      case '/admin/regional-admins': return RegionalAdminsScreen(loggedIn: li);
      case '/admin/commission-config': case '/admin/billing': case '/regional/billing': return CommissionConfigScreen(loggedIn: li);
      case '/admin/security': case '/regional/security': return SecuritySettingsScreen(loggedIn: li);
      case '/admin/workflows': return WorkflowInstancesScreen(loggedIn: li, admin: true, title: 'Parcours');
      case '/admin/workflows/templates': return WorkflowTemplatesScreen(loggedIn: li, title: 'Modèles système');
      case '/admin/workflows/compliance': return WorkflowTemplatesScreen(loggedIn: li, title: 'Conformité');
      case '/admin/workflows/audit': return WorkflowAuditScreen(loggedIn: li);
      ...
      case '/regional/required-documents': return RequiredDocumentsScreen(loggedIn: li);
      case '/regional/clinical-knowledge': return ClinicalKnowledgeScreen(loggedIn: li);
      case '/regional/workflows': return WorkflowTemplatesScreen(loggedIn: li, title: 'Après réservation');
      case '/regional/workflows/suggestions': return WorkflowSuggestionsScreen(loggedIn: li, title: 'Demandes prestataires');
      ...
      case '/provider/{slug}/workflows': return WorkflowInstancesScreen(loggedIn: li, title: 'Parcours');
      case '/provider/{slug}/workflows/my-suggestions': return WorkflowSuggestionsScreen(loggedIn: li, title: 'Mes suggestions');
